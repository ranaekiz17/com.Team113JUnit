...
public class C01_TestNotasyonu {
   ...
   Bu class icerisinde 3 test calıstiralim
   ...
   3-amazon anasayfaya gidip, url'in amazon logosunun gorundugunu test edin
     */

    /*

    JUnit'in bize  sagladigi ilk ve belki en onemli ozellik
    test method'larinin bagimsiz olarak calistirilabilmesini saglayan
    @Test notasyonudur.

    JUnit ilee classlevel dan birden fazla test method'u calistirirsak
    hangi siralama ile calistiracagini ongoremeyiz ve yonetemeyiz

    Diyelim ki bir test methodu uzerinde calisiyorsunuz
    ve o method'un toplu çalistirlmalarda kullanilmasini istemiyorsunuz
